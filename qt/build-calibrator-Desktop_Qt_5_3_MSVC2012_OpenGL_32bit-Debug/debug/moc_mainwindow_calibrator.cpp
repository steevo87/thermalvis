...
struct qt_meta_stringdata_MainWindow_calibrator_t {
    QByteArrayData data[5];
    char stringdata[75];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MainWindow_calibrator_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MainWindow_calibrator_t qt_meta_stringdata_MainWindow_calibrator = {
    {
...
QT_MOC_LITERAL(4, 52, 22)
    ...
    "MainWindow_calibrator\0on_debugMode_toggled\0"
    "\0checked\0on_verboseMode_toggled"
};
...
const QMetaObject MainWindow_calibrator::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MainWindow_calibrator.data,
      qt_meta_data_MainWindow_calibrator,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MainWindow_calibrator.stringdata))
