...
public:
    ...
    void setupUi(QMainWindow *MainWindow_streamer)
    {
        ...
        zeroDegreesOffset_label->setGeometry(QRect(220, 70, 101, 16));
        ...
        degreesPerGraylevel_label->setGeometry(QRect(220, 10, 101, 20));
        ...
        desiredDegreesPerGraylevel_label->setGeometry(QRect(160, 40, 161, 20));
