...
public:
    ...
    void setupUi(QMainWindow *MainWindow_flow)
    {
        ...
        detector_1_label->setObjectName(QStringLiteral("detector_1_label"));
        ...
        detector_2_label->setObjectName(QStringLiteral("detector_2_label"));
        ...
        detector_3_label->setObjectName(QStringLiteral("detector_3_label"));
        ...
        matchingMode_label->setObjectName(QStringLiteral("matchingMode_label"));
